...
def model_load_test(test_df, target_dir, test_prediction_dir, test_prediction_name, max_seq_len=64, num_labels=2, batch_size=32, get_embeddings = True,embedding_name="robert_train_embeddings.pkl",sim_name="testRobertResult.pkl"):
    ...
    batch_time, total_time, accuracy, predictions = test(model, test_loader,sim_name= sim_name)
    ...
    if get_embeddings:
        with open(embedding_name,"wb") as e:
